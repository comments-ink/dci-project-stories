...
PRODUCTION = bool(os.getenv("PRODUCTION", False) in ["1", "True", "true"])
...
COMMENTS_INK_OBJECT_REACTIONS_ENUM = "project_stories.enums.ObjectReactionEnum"
